...
\textbf{Especificación de atributos}
     ...
     \item \textbf{codigo}(turno)
	 \item \textbf{codigo}(procedimiento_medico)
...
%blockado, código\_block\_horas,código\_acción\_medica);
%
...
%
%TURNO(\emph{código\_turno}, fecha\_turno, hora\_turno, observaciones, lugar, sobreturno, 
%blockado, código\_block\_horas,código\_acción\_medica, tipo\_doc\_profesional, 
