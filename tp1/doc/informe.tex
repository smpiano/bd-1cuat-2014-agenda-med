...
\item 
\textbf{Atributos con posible valor nulo}: FALTA!!
\end{itemize}
...
\item 
\textbf{Atributos}: tipo\_documento\_persona, numero\_documento\_persona, matricula, celular,  nombre\_especialidad
